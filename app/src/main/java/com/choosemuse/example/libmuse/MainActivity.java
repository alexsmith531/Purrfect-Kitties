...
public class MainActivity extends Activity implements OnClickListener {
    /**
     * Number of times user has blinked this session
     */
    double lastBlinkTime = 0.0;
    int numTimesBlinked = 0;

    int numTimesNodded = 777;
    int stageOfNod = 0;
...
//        acc_z.setText(String.format("%6.2f", accelBuffer[2]));
    ...
    private void updateNod() {
        // TODO
        TextView nodText = (TextView)findViewById(R.id.nodDisplay);
        nodText.setText(String.format("%d", numTimesNodded));
    }
